...
<div id="cloneModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Modal Clone Box</h4>
            </div>
            <div class="modal-body">
                <h3 class="text-center">Are you sure you want to clone this post?</h3>
            </div>
            <div class="modal-footer">
                <a href="" class="btn btn-success modal_clone_link">Clone</a>
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
            </div>
        </div>
